...
export default function UsersTable({ caption = undefined }) {
  ...
  return (
    <div className="flex flex-col w-full h-auto space-y-2">
      <div className="flex flex-col lg:flex-row items-center lg:justify-between space-y-2 lg:space-y-0 lg:space-x-2">
        <div className="flex flex-col lg:flex-row items-center space-y-2 lg:space-y-0 lg:space-x-2">
          <Input type="text" placeholder="Search for user..." />
        </div>

        <div className="flex flex-col lg:flex-row items-centerspace-y-2 lg:space-y-0 lg:space-x-2">
      ...
      <div className="flex flex-col lg:flex-row items-center space-y-2 lg:space-y-0 lg:space-x-2">
        ...
        >
          <SelectTrigger className="lg:max-w-[180px] w-full">
