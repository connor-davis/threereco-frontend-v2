...
export const putApiAuthenticationMfaDisable = <ThrowOnError extends boolean = false>(options: Options<PutApiAuthenticationMfaDisableData, ThrowOnError>) => { return (options?.client ?? client).put<PutApiAuthenticationMfaDisableResponse, PutApiAuthenticationMfaDisableError, ThrowOnError>({
    ...options,
