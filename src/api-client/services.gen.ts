...
export const putApiAuthenticationDisableMfa = <ThrowOnError extends boolean = false>(options: Options<PutApiAuthenticationDisableMfaData, ThrowOnError>) => { return (options?.client ?? client).put<PutApiAuthenticationDisableMfaResponse, PutApiAuthenticationDisableMfaError, ThrowOnError>({
    ...options,
