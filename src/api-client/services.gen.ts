...
export const deleteApiAuthenticationDisableMfa = <ThrowOnError extends boolean = false>(options: Options<DeleteApiAuthenticationDisableMfaData, ThrowOnError>) => { return (options?.client ?? client).delete<DeleteApiAuthenticationDisableMfaResponse, DeleteApiAuthenticationDisableMfaError, ThrowOnError>({
    ...options,
