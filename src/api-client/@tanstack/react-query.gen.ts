...
export const deleteApiAuthenticationDisableMfaMutation = (options?: Partial<Options<DeleteApiAuthenticationDisableMfaData>>) => { const mutationOptions: UseMutationOptions<DeleteApiAuthenticationDisableMfaResponse, DeleteApiAuthenticationDisableMfaError, Options<DeleteApiAuthenticationDisableMfaData>> = {
    mutationFn: async (localOptions) => {
