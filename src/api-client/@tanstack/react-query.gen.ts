...
export const putApiAuthenticationDisableMfaMutation = (options?: Partial<Options<PutApiAuthenticationDisableMfaData>>) => { const mutationOptions: UseMutationOptions<PutApiAuthenticationDisableMfaResponse, PutApiAuthenticationDisableMfaError, Options<PutApiAuthenticationDisableMfaData>> = {
    mutationFn: async (localOptions) => {
        const { data } = await putApiAuthenticationDisableMfa({
            ...options,
            ...localOptions,
            throwOnError: true
        });
